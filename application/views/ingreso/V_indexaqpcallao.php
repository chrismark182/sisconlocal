...
<div class="section container center" style="padding-top: 0px">
 ...
 <!--<div class="input-field col offset-m1 m2 right-align">-->
 <div class="input-field col s1">
<div class="btn-small" id="btnBuscartra" onclick="BuscarTra(1,1,0)" ><i class="material-icons">search</i></div>
</div>

<div class="input-field col m1 right-align">
 	<a class="btn-small" onclick="MovimientoPersona(1,1,1)"   target="_blank"><i class="material-icons">archive</i></a>
</div>


<!--<div class="input-field col s2 right">-->
<!--<div class="input-field col m1 left-align">-->
<div class="input-field col s1">
<a class="btn-small red" href="<?= base_url()?>ingreso/nuevotrabajador" id="addtra" ><i class="material-icons">add</i></a>
</div>

<!--<div class="input-field col m2 left-align right" style="margin: 0px; font-size: 12px;">-->
<div class="input-field col s2 left-align right" style="font-size: 12px;">
<b>
Registros <span id="totaltra" class="btn blue-grey darken-2">0</span>
</b>
</div>		
        </form>
    </div>    
...
<div class="input-field col s1">
<div class="btn-small" id="btnBuscartra" onclick="BuscarPro(1,2,0)" ><i class="material-icons">search</i></div>
</div>
			
 <div class="input-field col s1">
	 <a class="btn-small" onclick="MovimientoPersona(1,2,2)"  target="_blank"><i class="material-icons">archive</i></a>
 </div>
...
<div id="modal1" class="modal">
	...
	<div class="row">
		...
		<!--</form>-->
			...
			<div class="input-field col s6">
				<input  id="pase" type="text" value=" " name="pase" readonly disabled >
				<label>Pase</label>
			</div>
			
			<div class="input-field col s6">
				<input  id="temperatura" type="text" value=" " name="temperatura" readonly disabled >
			...
			<div class="input-field col s6">
			<input  id="tipoalmacen" type="text" value=" " name="tipoalmacen" readonly disabled >
				<label>Almacen</label>
			</div>
			
			<div class="input-field col s6">
			<input  id="tiposervicio" type="text" value=" " name="tiposervicio" readonly disabled >
	...
	<div class="row">
		...
		<div class="input-field col s4">
			<input id="observaciones" maxlength="200" type="text" value=" "  readonly disabled>
...
<div id="modal2" class="modal">
	<div class="modal-content">
		...
		<div class="col s8">
			...
			<div class="input-field col s6">
				<input  id="area" type="text" value=" " name="area" readonly disabled >
				<label>Area</label>
			</div>
			...
			<div class="input-field col s6">
				<input  id="condicion" type="text" value=" " name="condicion" readonly disabled >
				<label id="lcondicion">Condicion</label>
			</div>
...
if(categoria==7 || categoria==15 || categoria==16)
{
	categoria=1;
}
...
if(altercategoria==7 || altercategoria==15  || altercategoria==16 ){
...
function BuscarTra(num,tipolistado,accion){
		...
		let sp = 'MOVIMIENTO_PERSONA_LIS_AQPCALLAO';
...
async function Ver(e)
	{
		...
		let url = '<?= base_url() ?>api/execsp';
		let sp = "MOVIMIENTO_PERSONA_DATAAQPCALLAO";
		...
		.then(function(data){
			...
			console.log(data);
				...
				document.getElementById('pase').value = data[0].MOVPER_C_PASE;
				document.getElementById('temperatura').value = data[0].TEMPERATURA;
				...
				document.getElementById('tipoalmacen').value = data[0].TIPLALMACEN_C_DESCRIPCION;
				document.getElementById('tiposervicio').value = data[0].TIPSERVICIO_C_DESCRIPCION;
...
async function Ver2(e)
{
		...
		.then(function(data){
			...
			let condicion = data[0].MOVPER_C_CONDICION;
			if(condicion == 1)
			{
			condicion="Apto";
			}
...
function MovimientoPersona(num,tipolistado,tipodatos){	
	...
	*/
	...
	window.open("<?php echo base_url(); ?>ingreso/exportaraqpcallao?var1="+empresa+"&var2="+dni+"&var3="+empresa_visitante+"&var4="+apellido+"&var5="+placa+"&var6="+fecha_desde+"&var7="+fecha_hasta+"&var8="+situacion+"&var9="+tipo_ingreso+"&var10="+tipobusqueda+"&var11="+tipolistado+"&var12="+tipodatos, "_blank");
}
